...
echo "  docker compose exec zfundpilot python -c \"from zfundpilot.scheduler import get_status; print(get_status())\"  # 查看定时任务状态"
echo "  docker compose logs --tail 200 | grep sched   # 查看定时任务执行日志"
